...
\begin{itemize}
	...
	\item Topic and partition: Apache Pulsar organizes messages into different topics. Each broker is responsible for read/write requests of a different subset of topics. A topic can also be split further into multiple partitions. However, a partition is internally also a normal Pulsar topic which is managed transparently to users by Pulsar. Messages in a Pulsar partition or a non-partitioned topic are uniquely identified by message IDs.
...
\input{chapters/evaluation/reliability}
