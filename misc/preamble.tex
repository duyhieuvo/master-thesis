...
% Set name and title
\author{Vo Duy Hieu}
\title{AN EVALUATION OF DIFFERENT OPEN-SOURCE EVENT-STREAM-PROCESSING PLATFORMS TOWARDS CONSTRUCTING A FEATURE MATRIX}
\date{\today}
...
\definecolor{colComments}{rgb}{0,0.5,0.5}
